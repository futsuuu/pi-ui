...
// Color scale values copied verbatim from Tailwind CSS v4 (node_modules/tailwindcss/theme.css)
// so that migrating utilities to semantic tokens never shifts a single color value.
  ...
  theme: {
    extend: {
      tokens: {
        ...
        colors: { gray, red, green, blue, amber },
        shadows: {
      ...
      semanticTokens: {
        colors: {
          ...
          border: {
            ...
            divider: {
              value: { base: "{colors.gray.100}", _dark: "oklch(27.8% 0.033 256.848 / 0.8)" },
            },
          },
          danger: {
            DEFAULT: { value: { base: "{colors.red.600}", _dark: "{colors.red.400}" } },
            strong: { value: { base: "{colors.red.700}", _dark: "{colors.red.300}" } },
            soft: { value: { base: "{colors.red.50}", _dark: "oklch(39.6% 0.141 25.723 / 0.2)" } },
